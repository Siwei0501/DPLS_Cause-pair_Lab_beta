...
result_list = []
concrete_pair_format, col_names = return_cause_pair()
values_return = return_Cause_DF(file_value_list=concrete_pair_format, reverse=False, thread=Thread, pre_process=Pre_process, seed=test_seed,
                              method=Method, **Kwargs)
values_Re_return = return_Cause_DF(file_value_list=concrete_pair_format, reverse=True, thread=Thread, pre_process=Pre_process, seed=test_seed,
                            method=Method, **Kwargs)
...
result_DF.to_excel(rf'analysis/{Method}/{Relation}_concrete_{Pre_process_name}{Kwargs_name}_{Method}.xlsx')