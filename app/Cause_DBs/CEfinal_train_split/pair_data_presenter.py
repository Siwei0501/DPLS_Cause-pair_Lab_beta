...
def return_cause_pair(relation: Literal['AB', 'BA', 'AB&BA'], threshold: list, test_SAMPLE: int = 200, seed=5, **kwargs):
    ...
    for relation_ in relation:
        ...
        folder_path = os.path.join(base_dir, rf'dataset/{relation_[0]}→{relation_[1]}')
...
if __name__ == '__main__':
    ...
    read_files, file_names, file_ys, X, y = return_cause_pair(relation='AB&BA', threshold=[0,5000], test_SAMPLE=100, seed=5)
    a=1